// WaterMark.swift - SoftEther Protocol Signature
// This is the magic signature data used during handshake

import Foundation

/// SoftEther WaterMark namespace
public enum WaterMark {
    /// Signature data used for protocol identification
    public static let signature = Data(bytes)
